...
enum state previous_state = Display;
char graph_title[5] = "DEF:";

uint8_t menu_cursor_placement = 1;
uint8_t D1_RES_INDEX = 0;
uint8_t D2_RES_INDEX = 0;
uint8_t USB_EN = 1;
uint32_t mean_pressure = 0;
